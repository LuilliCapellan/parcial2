        ...
        function insertarTable(formularios) {
            ...
            for (let key in formularios) {
                if (formularios[key].enviado_al_servidor == 0) {
                    ...
                    filaTabla.insertCell().innerHTML = '<button class="btn btn-primary" id="' + formularios[key].codigo + '" onclick="editandoFormulario('+ formularios[key].codigo + ')" style="margin-right: 15px;">Editar</button><button class="btn btn-primary" onclick="eliminarFormulario('+ formularios[key].codigo +')">Eliminar</button>';
                }
            }
                ...
                formulario.openCursor().onsuccess = (e) => {
                    ...
                    if(cursor) {
                        if (cursor.value.enviado_al_servidor === 0) {
                            ...
                            cursor.continue();
                            // formularios.push(objetoFormulario);
                            // console.log(cursor.value.nombre);
                        } else {
                            cursor.continue();
                        }
...
<body>
    <#include "/navBar.ftl">
    <div id="dialog-form" title="Editar Formulario">
        <form>
            <fieldset>
                ...
                <!--<input type="text" name="nivelEscolar" id="nivelEscolar" value="" class="text ui-widget-content ui-corner-all">-->
                <div class="form-group">
                    <label for="nivelEscolar">Nivel Escolar</label>
                    <select class="form-control" name="nivelEscolar" id="nivelEscolar" class="text ui-widget-content ui-corner-all">
    ...
    <button type="submit" onclick="enviarFormulario()" id="enviarServidor" class="btn btn-primary" style="width: 100%;">Enviar al servidor</button>
</body>
</html>